...
<link rel="stylesheet" href="css/sampledashboard.css">
</head>
<body>
...
<button class="menu-btn" onclick="toggleMenu()">☰ Add/Print</button>

<div class="menu-dropdown" id="menuDropdown">

<button onclick="printSection()" class="menu-item">Print Rankings</button>

<?php if($_SESSION['role']=='MSWDO'): ?>
<a href="add_household.php" class="menu-item">Add Household</a>
<?php endif; ?>
...
printWindow.document.write('<html><head><title>Household Rankings</title>');
printWindow.document.write('<link rel="stylesheet" href="css/sampledashboard.css">');
